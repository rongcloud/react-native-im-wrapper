...
- (NSInteger)loadUnreadMentionedMessages:(RCIMIWConversationType)type targetId:(NSString *)targetId channelId:(NSString *)channelId;

- (NSInteger)loadFirstUnreadMessage:(RCIMIWConversationType)type targetId:(NSString *)targetId channelId:(NSString *)channelId;
...
/*!
 ...
 @param types            会话类型的数组（ 需要将 RCIMIWConversationType 转为 NSNumber 构建 NSArray ）
 ...
 @remarks 会话
 */
- (NSInteger)loadConversations:(NSArray<NSNumber *> *)types
                     channelId:(NSString *)channelId
...
/*!
 ...
 @remarks 会话
 */
- (NSInteger)removeConversations:(NSArray<NSNumber *> *)conversationTypes channelId:(NSString *)channelId;
