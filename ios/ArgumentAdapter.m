...
RCIMIWImportanceHW toImportanceHW(NSUInteger w) {
  ...
  if (!RCIMIWImportanceHW_array) {
    RCIMIWImportanceHW_array = @[ @(RCIMIWImportanceHWNormal), @(RCIMIWImportanceHWLow) ];
  }
...
RCIMIWMessageOperationPolicy toMessageOperationPolicy(NSUInteger policy) {
  ...
  if (!RCIMIWMessageOperationPolicy_array) {
    RCIMIWMessageOperationPolicy_array = @[ @(RCIMIWMessageOperationPolicyLocal), @(RCIMIWMessageOperationPolicyRemote), @(RCIMIWMessageOperationPolicyLocalRemote) ];
  }
  if (policy > [RCIMIWMessageOperationPolicy_array count] - 1)
    policy = [RCIMIWMessageOperationPolicy_array count] - 1;

  return (RCIMIWMessageOperationPolicy)[RCIMIWMessageOperationPolicy_array[policy] integerValue];
}
...
RCIMIWVIVOPushType toVIVOPushType(NSUInteger type) {
  ...
  if (!RCIMIWVIVOPushType_array) {
    RCIMIWVIVOPushType_array = @[ @(RCIMIWVIVOPushTypeOperate), @(RCIMIWVIVOPushTypeSystem) ];
  }
...
RCIMIWSentStatus toSentStatus(NSUInteger status) {
  ...
  if (!RCIMIWSentStatus_array) {
    RCIMIWSentStatus_array = @[ @(RCIMIWSentStatusSending), @(RCIMIWSentStatusFailed), @(RCIMIWSentStatusSent), @(RCIMIWSentStatusReceived), @(RCIMIWSentStatusRead), @(RCIMIWSentStatusDestroyed), @(RCIMIWSentStatusCanceled) ];
  }
...
RCIMIWPushNotificationQuietHoursLevel toPushNotificationQuietHoursLevel(NSUInteger level) {
  ...
  if (!RCIMIWPushNotificationQuietHoursLevel_array) {
    RCIMIWPushNotificationQuietHoursLevel_array = @[ @(RCIMIWPushNotificationQuietHoursLevelNone), @(RCIMIWPushNotificationQuietHoursLevelMention), @(RCIMIWPushNotificationQuietHoursLevelBlocked) ];
  }
  if (level > [RCIMIWPushNotificationQuietHoursLevel_array count] - 1)
    level = [RCIMIWPushNotificationQuietHoursLevel_array count] - 1;

  return (RCIMIWPushNotificationQuietHoursLevel)[RCIMIWPushNotificationQuietHoursLevel_array[level] integerValue];
}
...
RCIMIWMessageDirection toMessageDirection(NSUInteger direction) {
  ...
  if (!RCIMIWMessageDirection_array) {
    RCIMIWMessageDirection_array = @[ @(RCIMIWMessageDirectionSend), @(RCIMIWMessageDirectionReceive) ];
  }
  if (direction > [RCIMIWMessageDirection_array count] - 1)
    direction = [RCIMIWMessageDirection_array count] - 1;

  return (RCIMIWMessageDirection)[RCIMIWMessageDirection_array[direction] integerValue];
}
...
RCIMIWReceivedStatus toReceivedStatus(NSUInteger status) {
  ...
  if (!RCIMIWReceivedStatus_array) {
    RCIMIWReceivedStatus_array = @[ @(RCIMIWReceivedStatusUnread), @(RCIMIWReceivedStatusRead), @(RCIMIWReceivedStatusListened), @(RCIMIWReceivedStatusDownloaded), @(RCIMIWReceivedStatusRetrieved), @(RCIMIWReceivedStatusMultipleReceive) ];
  }
  if (status > [RCIMIWReceivedStatus_array count] - 1)
    status = [RCIMIWReceivedStatus_array count] - 1;

  return (RCIMIWReceivedStatus)[RCIMIWReceivedStatus_array[status] integerValue];
}
...
RCIMIWChatRoomMemberActionType toChatRoomMemberActionType(NSUInteger type) {
  ...
  if (!RCIMIWChatRoomMemberActionType_array) {
    RCIMIWChatRoomMemberActionType_array = @[ @(RCIMIWChatRoomMemberActionTypeUnknown), @(RCIMIWChatRoomMemberActionTypeJoin), @(RCIMIWChatRoomMemberActionTypeLeave) ];
  }
  if (type > [RCIMIWChatRoomMemberActionType_array count] - 1)
    type = [RCIMIWChatRoomMemberActionType_array count] - 1;

  return (RCIMIWChatRoomMemberActionType)[RCIMIWChatRoomMemberActionType_array[type] integerValue];
}
...
RCIMIWPushNotificationLevel toPushNotificationLevel(NSUInteger level) {
  ...
  if (!RCIMIWPushNotificationLevel_array) {
    RCIMIWPushNotificationLevel_array = @[ @(RCIMIWPushNotificationLevelAllMessage), @(RCIMIWPushNotificationLevelNone), @(RCIMIWPushNotificationLevelMention), @(RCIMIWPushNotificationLevelMentionUsers), @(RCIMIWPushNotificationLevelMentionAll), @(RCIMIWPushNotificationLevelBlocked) ];
  }
  if (level > [RCIMIWPushNotificationLevel_array count] - 1)
    level = [RCIMIWPushNotificationLevel_array count] - 1;

  return (RCIMIWPushNotificationLevel)[RCIMIWPushNotificationLevel_array[level] integerValue];
}
...
RCIMIWMessageType toMessageType(NSUInteger type) {
  ...
  if (!RCIMIWMessageType_array) {
    RCIMIWMessageType_array = @[ @(RCIMIWMessageTypeUnknown), @(RCIMIWMessageTypeCustom), @(RCIMIWMessageTypeText), @(RCIMIWMessageTypeVoice), @(RCIMIWMessageTypeImage), @(RCIMIWMessageTypeFile), @(RCIMIWMessageTypeSight), @(RCIMIWMessageTypeGIF), @(RCIMIWMessageTypeRecall), @(RCIMIWMessageTypeReference), @(RCIMIWMessageTypeCommand), @(RCIMIWMessageTypeCommandNotification), @(RCIMIWMessageTypeLocation) ];
  }
...
RCIMIWMessageBlockType toMessageBlockType(NSUInteger type) {
  ...
  if (!RCIMIWMessageBlockType_array) {
    RCIMIWMessageBlockType_array = @[ @(RCIMIWMessageBlockTypeUnknown), @(RCIMIWMessageBlockTypeGlobal), @(RCIMIWMessageBlockTypeCustom), @(RCIMIWMessageBlockTypeThirdParty) ];
  }
  if (type > [RCIMIWMessageBlockType_array count] - 1)
    type = [RCIMIWMessageBlockType_array count] - 1;

  return (RCIMIWMessageBlockType)[RCIMIWMessageBlockType_array[type] integerValue];
}
...
RCIMIWTimeOrder toTimeOrder(NSUInteger order) {
  ...
  if (!RCIMIWTimeOrder_array) {
    RCIMIWTimeOrder_array = @[ @(RCIMIWTimeOrderBefore), @(RCIMIWTimeOrderAfter) ];
  }
...
RCIMIWCustomMessagePolicy toCustomMessagePolicy(NSUInteger policy) {
  ...
  if (!RCIMIWCustomMessagePolicy_array) {
    RCIMIWCustomMessagePolicy_array = @[ @(RCIMIWCustomMessagePolicyCommand), @(RCIMIWCustomMessagePolicyNormal), @(RCIMIWCustomMessagePolicyStatus), @(RCIMIWCustomMessagePolicyStorage) ];
  }
  if (policy > [RCIMIWCustomMessagePolicy_array count] - 1)
    policy = [RCIMIWCustomMessagePolicy_array count] - 1;

  return (RCIMIWCustomMessagePolicy)[RCIMIWCustomMessagePolicy_array[policy] integerValue];
}
...
RCIMIWChatRoomStatus toChatRoomStatus(NSUInteger status) {
  ...
  if (!RCIMIWChatRoomStatus_array) {
    RCIMIWChatRoomStatus_array = @[ @(RCIMIWChatRoomStatusReset), @(RCIMIWChatRoomStatusDestroyManual), @(RCIMIWChatRoomStatusDestroyAuto) ];
  }
  if (status > [RCIMIWChatRoomStatus_array count] - 1)
    status = [RCIMIWChatRoomStatus_array count] - 1;

  return (RCIMIWChatRoomStatus)[RCIMIWChatRoomStatus_array[status] integerValue];
}
...
RCIMIWConversationType toConversationType(NSUInteger type) {
  ...
  if (!RCIMIWConversationType_array) {
    RCIMIWConversationType_array = @[ @(RCIMIWConversationTypeInvalid), @(RCIMIWConversationTypePrivate), @(RCIMIWConversationTypeGroup), @(RCIMIWConversationTypeChatroom), @(RCIMIWConversationTypeSystem), @(RCIMIWConversationTypeUltraGroup) ];
  }
  if (type > [RCIMIWConversationType_array count] - 1)
    type = [RCIMIWConversationType_array count] - 1;

  return (RCIMIWConversationType)[RCIMIWConversationType_array[type] integerValue];
}
...
RCIMIWErrorCode toErrorCode(NSUInteger code) {
  ...
  if (!RCIMIWErrorCode_array) {
    RCIMIWErrorCode_array = @[ @(RCIMIWErrorCodeSuccess), @(RCIMIWErrorCodeParamError), @(RCIMIWErrorCodeEngineDestroyed), @(RCIMIWErrorCodeNativeOperationError), @(RCIMIWErrorCodeResultUnknown) ];
  }
...
RCIMIWUltraGroupTypingStatus toUltraGroupTypingStatus(NSUInteger status) {
  ...
  if (!RCIMIWUltraGroupTypingStatus_array) {
    RCIMIWUltraGroupTypingStatus_array = @[ @(RCIMIWUltraGroupTypingStatusText) ];
  }
  if (status > [RCIMIWUltraGroupTypingStatus_array count] - 1)
    status = [RCIMIWUltraGroupTypingStatus_array count] - 1;

  return (RCIMIWUltraGroupTypingStatus)[RCIMIWUltraGroupTypingStatus_array[status] integerValue];
}
...
RCIMIWMentionedType toMentionedType(NSUInteger type) {
  ...
  if (!RCIMIWMentionedType_array) {
    RCIMIWMentionedType_array = @[ @(RCIMIWMentionedTypeAll), @(RCIMIWMentionedTypePart) ];
  }
...
RCIMIWChatRoomEntriesOperationType toChatRoomEntriesOperationType(NSUInteger type) {
  ...
  if (!RCIMIWChatRoomEntriesOperationType_array) {
    RCIMIWChatRoomEntriesOperationType_array = @[ @(RCIMIWChatRoomEntriesOperationTypeUpdate), @(RCIMIWChatRoomEntriesOperationTypeRemove) ];
  }
  if (type > [RCIMIWChatRoomEntriesOperationType_array count] - 1)
    type = [RCIMIWChatRoomEntriesOperationType_array count] - 1;

  return (RCIMIWChatRoomEntriesOperationType)[RCIMIWChatRoomEntriesOperationType_array[type] integerValue];
}
...
RCIMIWLogLevel toLogLevel(NSUInteger level) {
  ...
  if (!RCIMIWLogLevel_array) {
    RCIMIWLogLevel_array = @[ @(RCIMIWLogLevelNone), @(RCIMIWLogLevelError), @(RCIMIWLogLevelWarn), @(RCIMIWLogLevelInfo), @(RCIMIWLogLevelDebug), @(RCIMIWLogLevelVerbose) ];
  }
...
RCIMIWBlacklistStatus toBlacklistStatus(NSUInteger status) {
  ...
  if (!RCIMIWBlacklistStatus_array) {
    RCIMIWBlacklistStatus_array = @[ @(RCIMIWBlacklistStatusUnknown), @(RCIMIWBlacklistStatusInBlacklist), @(RCIMIWBlacklistStatusNotInBlacklist) ];
  }
  if (status > [RCIMIWBlacklistStatus_array count] - 1)
    status = [RCIMIWBlacklistStatus_array count] - 1;

  return (RCIMIWBlacklistStatus)[RCIMIWBlacklistStatus_array[status] integerValue];
}
...
RCIMIWConnectionStatus toConnectionStatus(NSUInteger status) {
  ...
  if (!RCIMIWConnectionStatus_array) {
    RCIMIWConnectionStatus_array = @[ @(RCIMIWConnectionStatusNetworkUnavailable), @(RCIMIWConnectionStatusConnected), @(RCIMIWConnectionStatusConnecting), @(RCIMIWConnectionStatusUnconnected), @(RCIMIWConnectionStatusKickedOfflineByOtherClient), @(RCIMIWConnectionStatusTokenIncorrect), @(RCIMIWConnectionStatusConnUserBlocked), @(RCIMIWConnectionStatusSignOut), @(RCIMIWConnectionStatusSuspend), @(RCIMIWConnectionStatusTimeout), @(RCIMIWConnectionStatusUnknown) ];
  }
  if (status > [RCIMIWConnectionStatus_array count] - 1)
    status = [RCIMIWConnectionStatus_array count] - 1;

  return (RCIMIWConnectionStatus)[RCIMIWConnectionStatus_array[status] integerValue];
}
